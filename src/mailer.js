...
export function ADMIN_CREATE_SUBSCRIPTION(data) {
  ...
  '<p>ATTENTION: Afin de confirmer votre abonnement veuillez effectuer le premier versement avant le lundi 25 janvier 2021 en suivant ce lien sécurisé: '+process.env.PRIORITARY_BOOKING_REDIRECT_URL+'/'+data.subscription+' </p>'+
  '<p>Cordialement,</p>'+
  '<p>L\'équipe Aquadream</p>'+
  '</br></br>'+
  '<em>PS: Ne répondez pas à ce message</em>'
